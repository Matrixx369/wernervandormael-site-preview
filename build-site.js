...
function header() {
  return `<header><nav class="nav container" aria-label="Hoofdnavigatie"><a class="brand" href="/" aria-label="Vandormael Werner home"><img src="/assets/images/vandormael-werner-logo.svg" alt="Vandormael Werner Dakwerken en Klussen" width="390" height="155"></a><button class="menu-toggle" aria-expanded="false" aria-controls="main-menu">Menu</button><div class="menu" id="main-menu"><a href="/">Home</a><a href="/#diensten">Dakwerken</a><details><summary>Diensten</summary><div class="dropdown">${services.map(s => `<a href="${s[1]}">${s[0]}</a>`).join("")}</div></details><a href="/projecten/">Projecten</a><a href="/over-vandormael-werner/">Over</a><a href="/contact/">Contact</a></div><a class="btn btn-red nav-call" href="tel:${phone}">Bel Werner</a></nav></header>`;
}
...
function homeBody(page) {
  ...
  <section><div class="container process-pro"><div class="process-intro"><span class="kicker">Onze werkwijze</span><h2>Zo pakken we uw dakwerk aan</h2><p>Geen ingewikkeld traject. Eerst duidelijk bekijken wat nodig is, daarna praktisch afspreken en correct uitvoeren.</p></div><div class="steps">${[["1","Contact","U neemt contact op via telefoon, mail of het formulier."],["2","Situatie bekijken","We bekijken wat er aan de hand is en welke oplossing logisch is."],["3","Plaatsbezoek indien nodig","Als het niet duidelijk is op afstand, plannen we een plaatsbezoek."],["4","Duidelijke uitleg","U krijgt heldere uitleg over de mogelijke aanpak en uitvoering."],["5","Uitvoering","Na akkoord worden de werken praktisch ingepland en correct uitgevoerd."]].map(x=>`<article><b>${x[0]}</b><h3>${x[1]}</h3><p>${x[2]}</p></article>`).join("")}</div></div></section>
